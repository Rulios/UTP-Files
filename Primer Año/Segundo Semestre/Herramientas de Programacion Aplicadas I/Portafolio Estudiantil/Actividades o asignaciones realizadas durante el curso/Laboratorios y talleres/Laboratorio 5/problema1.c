...
int main(){
	...
	int Robert = EncontrarEstudianteConMayorPromedio(estudiantes, 5);
	
	printf("--ESTUDIANTE CON MAYOR PROMEDIO--\n\n");
	
	printf("Nombre del estudiante:%s\n", estudiantes[Robert].nombre);
	printf("Apellido: %s\n", estudiantes[Robert].apellido);
	printf("Edad %i\n", estudiantes[Robert].edad);
	printf("Sexo : %s \n", estudiantes[Robert].sexo);
	printf("Promedio: %.2f", estudiantes[Robert].promedio);
