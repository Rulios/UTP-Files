...
//En la pronta reapertura de los vuelos internacionales. Una casa de cambio de monedas en el
//Aeropuerto Internacional de Tocumen requiere automatizar el cambio de divisas con respecto al
//dólar. El operador de la casa de cambio solo deberá introducir la cantidad y el tipo de moneda. El
//programa le indicará la cantidad en dólares; además, el programa se ejecutará n cantidad de veces
//hasta que el usuario decida finalizar. Utilice una función con retorno para calcular el cambio de
//moneda.

//Conversiones equivalente a un dólar
//
//1 BOLIVAR VENEZOLANO 32738.48
//2 DOLAR CANADIENSE 1.35
//3 LIBRA 0.78
//4 PESO COLOMBIANO 3777.51
//5 PESO MEXICANO 21.98
//6 YEN 107.30
//7 YUAN 7.07
//8 EURO 0.88
